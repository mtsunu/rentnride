(function (module) {
     ...
     */
    module.factory('WalletsFactory', ['$resource', 'GENERAL_CONFIG', function ($resource, GENERAL_CONFIG) {
     ...
     */
    module.factory('GetGatewaysFactory', ['$resource', 'GENERAL_CONFIG', function ($resource, GENERAL_CONFIG) {
     ...
     */
    module.factory('GetCountries', ['$resource', 'GENERAL_CONFIG', function ($resource, GENERAL_CONFIG) {
