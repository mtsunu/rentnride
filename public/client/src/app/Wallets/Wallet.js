(function (module) {
     ...
     **/
    module.controller('WalletsStatusController', ['$state', 'Flash', '$stateParams', '$filter', function ($state, Flash, $stateParams, $filter) {
     ...
     **/
    module.controller('WalletsController', ['$state', '$scope', '$http', 'Flash', '$filter', 'WalletsFactory', '$rootScope', '$location', '$window', 'GetGatewaysFactory', '$sce', 'GetCountries', 'ConstPaymentGateways', function ($state, $scope, $http, Flash, $filter, WalletsFactory, $rootScope, $location, $window, GetGatewaysFactory, $sce, GetCountries, ConstPaymentGateways) {
