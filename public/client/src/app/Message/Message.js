(function (module) {
     ...
     **/
    module.controller('MessageController', ['$state', '$auth', '$scope', 'Flash', '$http', '$filter', '$rootScope', '$location', 'InboxFactory', 'GetMessageFactory', 'StarMailFactory', 'SentMailFactory', function ($state, $auth, $scope, Flash, $http, $filter, $rootScope, $location, InboxFactory, GetMessageFactory, StarMailFactory, SentMailFactory) {
        var model = this;
        $scope.maxSize = 5;
        var params = {};
