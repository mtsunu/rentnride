(function (module) {
     ...
     **/
    module.controller('HeaderController', ['$state', '$scope', '$rootScope', '$auth', 'ResolveService', 'AuthFactory', 'ConstSocialLogin', 'ConstThumb', '$location', '$filter', function ($state, $scope, $rootScope, $auth, ResolveService, AuthFactory, ConstSocialLogin, ConstThumb, $location, $filter) {
        var model = this;
        /**
         * @ngdoc method
         * @name setMetaData
