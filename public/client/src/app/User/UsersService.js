(function (module) {
    ...
    module.factory('UserChangePasswordFactory', ['$resource', 'GENERAL_CONFIG', function ($resource, GENERAL_CONFIG) {
    ...
    module.factory('MyVehiclesFactory', ['$resource', 'GENERAL_CONFIG', function ($resource, GENERAL_CONFIG) {
    ...
    module.factory('statsFactory', ['$resource', 'GENERAL_CONFIG', function ($resource, GENERAL_CONFIG) {
