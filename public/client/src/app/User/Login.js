(function (module) {
     ...
     **/
    module.controller('UserLoginController', ['$auth', '$state', 'Flash', '$rootScope', '$filter', 'AuthFactory', '$location', 'cfpLoadingBar', function ($auth, $state, Flash, $rootScope, $filter, AuthFactory, $location, cfpLoadingBar) {
        var model = this;
        /**
         * @ngdoc method
         * @name setMetaData
