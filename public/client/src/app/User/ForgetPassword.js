(function (module) {
     ...
     **/
    module.controller('ForgotPasswordController', ['$state', '$window', '$scope', '$rootScope', '$location', 'Flash', '$filter', 'ForgotPasswordFactory', function ($state, $window, $scope, $rootScope, $location, Flash, $filter, ForgotPasswordFactory) {
        var model = this;
        $scope.user = {};
