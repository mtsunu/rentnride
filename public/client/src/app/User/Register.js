(function (module) {
     ...
     **/
    module.controller('UserRegisterController', ['$auth', '$state', 'Flash', '$rootScope', '$filter', 'AuthFactory', '$location', 'vcRecaptchaService', '$scope', function ($auth, $state, Flash, $rootScope, $filter, AuthFactory, $location, vcRecaptchaService, $scope) {
        var model = this;
        /**
         * @ngdoc method
         * @name setMetaData
