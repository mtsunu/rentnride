(function (module) {
     ...
     **/
    module.controller('UserProfileController', ['$state', '$scope', 'Flash', 'UserProfilesFactory', '$filter', '$rootScope', '$location', 'Upload', 'GENERAL_CONFIG', 'ConstSocialLogin', 'ConstThumb', function ($state, $scope, Flash, UserProfilesFactory, $filter, $rootScope, $location, Upload, GENERAL_CONFIG, ConstSocialLogin, ConstThumb) {
        var model = this;
        /**
         * @ngdoc method
         * @name setMetaData
