(function (module) {
     ...
     **/
    module.controller('ChangePasswordController', ['$state', '$auth', '$scope', 'Flash', '$http', '$filter', '$rootScope', '$location', 'UserChangePasswordFactory', function ($state, $auth, $scope, Flash, $http, $filter, $rootScope, $location, UserChangePasswordFactory) {
        $scope.user = {};
        /**
         * @ngdoc method
         * @name setMetaData
