(function (module) {
     ...
     **/
    module.controller('UserController', ['$scope', '$auth', '$state', 'UsersFactory', '$rootScope', '$filter', 'UserActivateFactory', 'Flash', 'AuthFactory', '$location', 'ConstSocialLogin', function ($scope, $auth, $state, UsersFactory, $rootScope, $filter, UserActivateFactory, Flash, AuthFactory, $location, ConstSocialLogin ) {
        var model = this;
        model.maxSize = 5;
        /**
         * @ngdoc method
