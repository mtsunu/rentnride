(function (module) {
     ...
     **/
    module.controller('DashboardController', ['$state', '$scope', '$http', 'Flash', 'AuthFactory', 'GENERAL_CONFIG', '$filter', '$rootScope', 'ConstThumb', 'ConstSocialLogin', 'MyVehiclesFactory', 'statsFactory', '$uibModal', function ($state, $scope, $http, Flash, AuthFactory, GENERAL_CONFIG, $filter, $rootScope, ConstThumb, ConstSocialLogin, MyVehiclesFactory, statsFactory, $uibModal) {
        var model = this;
        /**
         * @ngdoc method
         * @name init
