...
(function (app) {
     ...
     **/
    app.controller('AppController', ['$scope', '$auth', '$rootScope', function ($scope, $auth, $rootScope) {
        // Search block close
        /**
         * @ngdoc method
         * @name scrollMoveTop
     ...
     */
    app.service('ResolveService', ['$auth', '$rootScope', 'GENERAL_CONFIG', 'AuthFactory', '$q', '$location', '$state', 'Flash', '$filter', function ($auth, $rootScope, GENERAL_CONFIG, AuthFactory, $q, $location, $state, Flash, $filter) {
        var promiseSettings;
        var promiseAuth;
