(function (module) {
     ...
     **/
    module.controller('TransactionController', ['$state', '$scope', '$http', 'Flash', '$filter', 'TransactionFactory', 'AuthFactory', '$rootScope', '$location', function ($state, $scope, $http, Flash, $filter, TransactionFactory, AuthFactory, $rootScope, $location) {
        var model = this;
        $scope.maxSize = 5;
